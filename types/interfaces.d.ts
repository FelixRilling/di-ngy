...
interface IDingyCli extends IClingy {
    ...
    getCommand(path: string[], pathUsed?: string[]): IDingyCliLookupSuccessful | IDingyCliLookupMissingCommand;
...
export { IDingy, IDingyUtils, IDingyStrings, IDingyConfig, IDingyConfigRole, IDingyUserEvents, IDingyCommandResolved, IDingyMessageResultExpanded, IDingyMessageResultEvents, IDingyCli, IDingyCliArg, IDingyCliCommand, IDingyCliCommands, IDingyCliLookupArgs, IDingyCliLookupMissingArg, IDingyCliLookupMissingCommand, IDingyCliLookupSuccessful, IDingyCliOptions };
